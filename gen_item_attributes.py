...
# Credentials are read from the environment (see .env.example). Never hard-code keys.
api_key = os.getenv("LLM_API_KEY")
api_base = os.getenv("LLM_API_BASE", "https://gpt-api.hkust-gz.edu.cn/v1/chat/completions")
if not api_key:
    raise EnvironmentError(
        "LLM_API_KEY is not set. Export it (e.g. `export LLM_API_KEY=...`) "
