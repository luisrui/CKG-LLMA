...
if __name__ == "__main__":
    ...
    parse.add_argument("--argpath", type=str, default="config/CKG-LLMA/argsAB_origin.yaml", help="the relative path of argments file")
    ...
    scheduler = MultiStepLR(optimizer, milestones=[1000, 2000], gamma = 0.2)
    ...
    if args['Train']:
        ...
        Train(args, Recmodel, rec_data, kg_train_data, None, contrast_model, optimizer, scheduler)
