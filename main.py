...
if __name__ == "__main__":
    ...
    scheduler = MultiStepLR(optimizer, milestones=[1500, 2500], gamma = 0.2)
    ...
    if args['Train']:
        ...
        Train(args, Recmodel, rec_data, kg_train_data, contrast_model, optimizer, scheduler)
        #result = Test(args, rec_data, Recmodel, "test", device)
        #Generate_subgraphs(50, args, Rec_data_loader, extractor, rec_data)
