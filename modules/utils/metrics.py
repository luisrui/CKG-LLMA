...
class TopkMetric(object):
    ...
    Args:
        args (args): The args of evaluator.
    """
    ...
    def __init__(self, args):
        #super().__init__(args)
        self.topk = args["topks"]
        self.decimal_place = args["metric_decimal_place"]

    def used_info(self, struct_result):
        """Get the bool matrix indicating whether the corresponding item is positive
        and number of positive items for each user.
        """
        rec_mat = struct_result.get("rec.topk")
    ...
    def topk_result(self, metric, value):
        ...
        Returns:
            dict: metric values required in the argsuration.
        """
        metric_dict = {}
...
class Precision(TopkMetric):
    ...
    def calculate_metric(self, struct_result : DataStruct):
        pos_index, _ = self.used_info(struct_result)
